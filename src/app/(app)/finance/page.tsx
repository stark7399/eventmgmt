// Latest change: theme-aware redesign (emerald accent) plus toast notifications on add/mark-paid/delete/log-payout errors.
"use client";
        ...
        <>
          <div className="mb-4">
            ...
            <select
              ...
              className="w-full rounded-lg border border-stone-200 bg-white px-3 py-2.5 text-sm text-stone-900 outline-none focus:border-section-finance dark:border-stone-800 dark:bg-stone-900 dark:text-stone-100"
            >
              {projects.map((p) => (
                ...
                {crewAssignments.map((a) => (
                  <li key={a.id} className="flex items-center justify-between text-xs">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="text-stone-400 dark:text-stone-500">${a.dailyRate.toLocaleString()}</span>
                      <button
    ...
    >
      <div className="flex gap-2">
        <select
          ...
          className="rounded-lg border border-stone-200 bg-stone-50 px-3 py-2.5 text-sm text-stone-900 outline-none focus:border-section-finance dark:border-stone-700 dark:bg-stone-950 dark:text-stone-100"
        >
        ...
        <input
          ...
          className="flex-1 rounded-lg border border-stone-200 bg-stone-50 px-3 py-2.5 text-sm text-stone-900 placeholder-stone-400 outline-none focus:border-section-finance dark:border-stone-700 dark:bg-stone-950 dark:text-stone-100"
        />
      </div>
      <input
        type="text"
        ...
        className="rounded-lg border border-stone-200 bg-stone-50 px-3 py-2.5 text-sm text-stone-900 placeholder-stone-400 outline-none focus:border-section-finance dark:border-stone-700 dark:bg-stone-950 dark:text-stone-100"
      />
