      ...
      <section>
        ...
        <form onSubmit={handleSubmit} className="mb-4 flex flex-col gap-2">
          <textarea
            ...
            className="rounded-lg border border-stone-200 bg-white px-3 py-2.5 text-base text-stone-900 placeholder-stone-400 outline-none focus:border-section-gallery dark:border-stone-800 dark:bg-stone-900 dark:text-stone-100"
          />
          <button
            type="submit"
