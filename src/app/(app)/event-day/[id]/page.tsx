// Latest change: category-colored filter chips and left-border accents on shot rows (visually distinct by category during a live event), plus toast notifications and theme redesign.
"use client";
    ...
    >
      ...
      >
        ...
        <textarea
          ...
          autoFocus
          className="mb-3 w-full rounded-lg border border-stone-200 bg-stone-50 px-3 py-2.5 text-sm text-stone-900 placeholder-stone-400 outline-none focus:border-amber-500 dark:border-stone-700 dark:bg-stone-950 dark:text-stone-100"
        />
