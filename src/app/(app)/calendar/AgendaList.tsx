// Latest change: shoot-date entries are auto-generated from project dates (no delete button, since there's no Firestore doc to delete) - only manually-added prep/post deadline events can be removed here.
"use client";
