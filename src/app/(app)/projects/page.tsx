// Latest change: "New Project" form now captures event start AND end date (instead of one date), and the project list shows the full date range.
"use client";
      ...
      <div className="flex gap-2">
        <div className="flex-1">
          ...
          <input
            ...
            className="w-full rounded-lg border border-stone-200 bg-stone-50 px-3 py-2.5 text-base text-stone-900 outline-none focus:border-section-projects dark:border-stone-700 dark:bg-stone-950 dark:text-stone-100"
          />
        </div>
        <div className="flex-1">
