// Latest change: editor field is now a dropdown of this project's assigned crew (instead of free text), and clicking a task card lets you edit its title/editor/deadline.
"use client";
...
function TaskForm({
  ...
  // De-duplicated crew names - the same person can hold more than one role/shift
  // on a project, but should only show up once in this picker.
  const crewNames = Array.from(new Set(crew.map((c) => c.crewName)));
