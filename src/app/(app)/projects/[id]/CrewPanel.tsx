// Latest change: crew shift is now a date range (no start/end time picker, which was the real cause of the mobile zoom bug) - matches how the event itself has a start/end date; bigger, bolder cards and buttons.
"use client";
...
function AssignmentForm({
  ...
  const [startDate, setStartDate] = useState(
    existing ? format(new Date(existing.shiftStartDate), "yyyy-MM-dd") : format(new Date(), "yyyy-MM-dd")
  );
  const [endDate, setEndDate] = useState(
    existing ? format(new Date(existing.shiftEndDate), "yyyy-MM-dd") : format(new Date(), "yyyy-MM-dd")
  );
