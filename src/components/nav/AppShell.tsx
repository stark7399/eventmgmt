// Latest change: app name "Studio" now shown in the header and links back to the dashboard when tapped.
"use client";
      ...
      <div className="flex min-h-screen flex-1 flex-col">
        <header className="flex items-center justify-between border-b border-stone-200 px-4 py-3 dark:border-stone-800 md:px-6">
          <Link href="/dashboard" className="flex items-center gap-2 md:hidden">
            <Aperture className="text-section-dashboard" size={22} />
            <span className="font-semibold text-stone-900 dark:text-stone-100">Studio</span>
          </Link>
