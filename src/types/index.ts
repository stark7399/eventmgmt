// Latest change: Project now has eventStartDate/eventEndDate (replacing single eventDate) and phase can be set manually at any time; ShotListItem gets assignedTo (crew name); EditingTask.assignedTo now expected to match a CrewAssignment.crewName on the project.
